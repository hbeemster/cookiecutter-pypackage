...
}}/{{ cookiecutter.project\_slug }}/issues.
...
cookiecutter.project\_slug }}]{.title-ref} for local development.

1.  Fork the [{{ cookiecutter.project\_slug }}]{.title-ref} repo on
    GitHub.
...
> \$ pytest [tests.test](){{ cookiecutter.project\_slug }}

{% else %}

:   \$ python -m unittest [tests.test](){{ cookiecutter.project\_slug }}
